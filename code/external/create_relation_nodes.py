# Copy from: https://github.com/ArneBinder/dialam-2024-shared-task/blob/main/src/utils/create_relation_nodes.py
...
from external.align_i2l_nodes import align_i_and_l_nodes
