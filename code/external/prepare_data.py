# Copy from: https://github.com/ArneBinder/dialam-2024-shared-task/blob/main/src/utils/prepare_data.py
...
# from document import AnnotationLayer, annotation_field
# from annotations import LabeledSpan, NaryRelation
...
from external.create_relation_nodes import (
    add_s_and_ya_nodes_with_edges,
    remove_s_and_ya_nodes_with_edges,
)
from external.nodeset_utils import (
    Node,
    Nodeset,
    Relation,
    get_id2node,
